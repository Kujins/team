  ...
  const handleTypeSelect = (type) => {
    ...
    switch (type) {
      case 'session':
        ...
        break;
      case 'view':
        navigate('/dashboard/appointments/view_appoinments');
        break;
      case 'service':
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        {(isParent || isAdmin || isResourcePerson || isPractitioner) && (
          ...
          >
            ...
            <h3 className="text-xl font-semibold text-indigo-800 mb-2">Manage doctors availability</h3>
            <p className="text-gray-600 text-center">Schedule doctors availability time.</p>
          </div>
        )}
        ...
        {(isParent || isAdmin || isResourcePerson || isPractitioner) && (
          <div
            ...
            onClick={() => handleTypeSelect('view')}
          >
            <div className="text-5xl mb-4 text-indigo-700">
              <i className="fas fa-users"></i>
            </div>
            <h3 className="text-xl font-semibold text-indigo-800 mb-2">View all doctor appoinments</h3>
            <p className="text-gray-600 text-center">Schedule doctors availability time.</p>
          </div>
        )}
