...
import Doctors_availability from './pages/Appointment/Doctors_availability'; // If you keep it
import View_appoinments from './pages/Appointment/View_appoinments'; // If you keep it
    ...
    <Router>
      <Routes>
        ...
        <Route path="/dashboard" element={<Dashboard />}>
          ...
          <Route path="appointments/session-booking" element={<Doctors_availability />} /> 
          <Route path="appointments/view_appoinments" element={<View_appoinments />} /> 
